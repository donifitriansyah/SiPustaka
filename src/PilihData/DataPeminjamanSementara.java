 ...
 */
public class DataPeminjamanSementara extends javax.swing.JDialog {
    ...
    private String kodeAnggotaSementara;

    /**
     * Creates new form DataPenerbit
     */
    public DataPeminjamanSementara(Dialog parent, boolean modal, String kodeAnggotaSementara) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        model = (DefaultTableModel) tblData.getModel();
        this.kodeAnggotaSementara = kodeAnggotaSementara;
        try {
    ...
    public void tampilData() {
        try {
            rs = perintah.executeQuery(
                    ...
                    + "WHERE status_peminjaman = 'Sedang Dipinjam' AND p.kode_anggota = '" + kodeAnggotaSementara + "'"
            );
            model.setRowCount(0);
