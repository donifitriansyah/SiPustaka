 ...
 */
public class DataPenerbit extends javax.swing.JDialog {
     ...
     */
    public DataPenerbit(Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tblData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Penerbit", "Nama Penerbit", "Situs"
            }
        ) {
        ...
        jLabel1.setText("Pilih Data Penerbit");
        ...
        jLabel2.setText("*Silahkan klik penerbit yang tersedia didalam tabel");
    ...
    private void tblDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDataMouseClicked
        if (tblData.getSelectedRow() >= 0) {
            kodePenerbit = model.getValueAt(tblData.getSelectedRow(), 0).toString();
            namaPenerbit = model.getValueAt(tblData.getSelectedRow(), 1).toString();
            dispose();
        }
